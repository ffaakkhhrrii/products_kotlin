package com.fakhri.products.data.paging
...
class ProductPagingAdapter(private val onClick: (Int)-> Unit) :
    PagingDataAdapter<Product, ProductPagingAdapter.ProductViewHolder>(DIFF_CALLBACK) {
    ...
    inner class ProductViewHolder(private val binding: ItemProductsBinding) :
        ...
        fun onBind(product: Product,onClick: (Int) -> Unit) {
